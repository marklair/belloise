...
<?php  if(isset($myself)) {
	 ?>
	 	<div class="grid_14"
			<p>
				Welcome Back, <?php echo ($myself['firstname']);  ?> ! <br>
...
?>
		...
		<div class="grid_14" style="text-align: center;">
			<h2>
				Welcome to the Belloise Inventory Control System...
			</h2>
			<?php
				echo $this->Html->link(__('Log In'), array('controller' => 'users', 'action' => 'login'), array('class' => 'bigolbutton'));
			?>
			<br><br><h2>or</h2><br>
			<?php
				echo $this->Html->link(__('Register As New Employee'), array('controller' => 'users', 'action' => 'add'), array('class' => 'bigolbutton'));
			?>
		</div>	    
